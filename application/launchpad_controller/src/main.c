...
int switch1_state = 0; // off, non-conducting, high-Z
int switch2_state = 0; // off, non-conducting, high-Z
int switch3_state = 0; // off, non-conducting, high-Z
int switch4_state = 0; // off, non-conducting, high-Z
